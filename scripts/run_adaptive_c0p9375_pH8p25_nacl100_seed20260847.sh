...
MANIFEST="$ROOT/manifests/adaptive_c0p9375_pH8p25_nacl100_seed20260847.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c0p9375_pH8p25_nacl100_seed20260847"
...
echo
echo "================================================================"
echo "ADAPTIVE_C0P9375_PH8P25_NACL100: COMPLETE"
echo "================================================================"
