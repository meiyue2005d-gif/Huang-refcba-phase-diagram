...
ROOT = Path("results/adaptive_c6p25_pH8p25_nacl100_seed20260850")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260850")):
    cluster_file = (
...
output = ROOT / "adaptive_c6p25_pH8p25_nacl100_seed20260850_metrics.csv"
