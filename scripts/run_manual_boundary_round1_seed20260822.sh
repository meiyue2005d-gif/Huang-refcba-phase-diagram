...
MANIFEST="$ROOT/manifests/manual_boundary_round1.tsv"
RESULT_ROOT="$ROOT/results/manual_boundary_30ns_round1_seed20260822"
...
echo
echo "================================================================"
echo "MANUAL_BOUNDARY_ROUND1_20260822: COMPLETE"
echo "================================================================"
