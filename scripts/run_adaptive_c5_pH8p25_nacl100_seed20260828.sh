...
MANIFEST="$ROOT/manifests/adaptive_c5_pH8p25_nacl100_seed20260828.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c5_pH8p25_nacl100_seed20260828"
...
echo
echo "================================================================"
echo "ADAPTIVE_C5_PH8P25_NACL100: COMPLETE"
echo "================================================================"
