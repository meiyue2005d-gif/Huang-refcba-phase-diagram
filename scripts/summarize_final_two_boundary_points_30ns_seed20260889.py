...
ROOT = Path("results/final_two_boundary_points_30ns_seed20260889")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260889")):
    cluster_file = (
...
output = ROOT / "final_two_boundary_points_30ns_seed20260889_metrics.csv"
