...
ROOT = Path("results/adaptive_c5_pH8p25_nacl100_seed20260854")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260854")):
    cluster_file = (
...
output = ROOT / "adaptive_c5_pH8p25_nacl100_seed20260854_metrics.csv"
