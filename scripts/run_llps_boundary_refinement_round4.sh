...
MANIFEST="$ROOT/manifests/llps_boundary_refinement_round4.tsv"
RESULT_ROOT="$ROOT/results/llps_boundary_refinement_30ns_round4"
...
echo
echo "================================================================"
echo "LLPS_BOUNDARY_REFINEMENT_ROUND4: COMPLETE"
echo "================================================================"
