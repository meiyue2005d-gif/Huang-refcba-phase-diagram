...
MANIFEST="$ROOT/manifests/llps_boundary_refinement_round2.tsv"
RESULT_ROOT="$ROOT/results/llps_boundary_refinement_30ns_round2"
...
echo
echo "================================================================"
echo "LLPS_BOUNDARY_REFINEMENT_ROUND2: COMPLETE"
echo "================================================================"
