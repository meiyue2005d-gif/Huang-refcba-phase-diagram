...
ROOT = Path("results/concentration_boundary_30ns_round3_seed20260883")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260883")):
    cluster_file = (
...
output = ROOT / "concentration_boundary_30ns_round3_seed20260883_metrics.csv"
