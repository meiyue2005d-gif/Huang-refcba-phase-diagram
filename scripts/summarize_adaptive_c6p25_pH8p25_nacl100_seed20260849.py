...
ROOT = Path("results/adaptive_c6p25_pH8p25_nacl100_seed20260849")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260849")):
    cluster_file = (
...
output = ROOT / "adaptive_c6p25_pH8p25_nacl100_seed20260849_metrics.csv"
