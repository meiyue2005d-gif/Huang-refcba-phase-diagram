...
ROOT = Path("results/adaptive_c1p25_pH8p25_nacl100_seed20260840")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260840")):
    cluster_file = (
...
output = ROOT / "adaptive_c1p25_pH8p25_nacl100_seed20260840_metrics.csv"
