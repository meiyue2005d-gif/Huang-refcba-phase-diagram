...
ROOT = Path("results/adaptive_c1p640625_pH8p25_nacl100_seed20260848")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260848")):
    cluster_file = (
...
output = ROOT / "adaptive_c1p640625_pH8p25_nacl100_seed20260848_metrics.csv"
