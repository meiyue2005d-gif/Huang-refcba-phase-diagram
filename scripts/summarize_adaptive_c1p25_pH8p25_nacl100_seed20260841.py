...
ROOT = Path("results/adaptive_c1p25_pH8p25_nacl100_seed20260841")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260841")):
    cluster_file = (
...
output = ROOT / "adaptive_c1p25_pH8p25_nacl100_seed20260841_metrics.csv"
