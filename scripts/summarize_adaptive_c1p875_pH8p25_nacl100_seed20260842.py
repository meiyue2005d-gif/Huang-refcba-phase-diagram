...
ROOT = Path("results/adaptive_c1p875_pH8p25_nacl100_seed20260842")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260842")):
    cluster_file = (
...
output = ROOT / "adaptive_c1p875_pH8p25_nacl100_seed20260842_metrics.csv"
