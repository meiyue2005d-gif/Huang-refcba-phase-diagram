...
MANIFEST="$ROOT/manifests/adaptive_c8p125_pH8p25_nacl100_seed20260851.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c8p125_pH8p25_nacl100_seed20260851"
...
echo
echo "================================================================"
echo "ADAPTIVE_C8P125_PH8P25_NACL100: COMPLETE"
echo "================================================================"
