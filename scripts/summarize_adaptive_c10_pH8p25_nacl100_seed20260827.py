...
ROOT = Path("results/adaptive_c10_pH8p25_nacl100_seed20260827")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260827")):
    cluster_file = (
...
output = ROOT / "adaptive_c10_pH8p25_nacl100_seed20260827_metrics.csv"
