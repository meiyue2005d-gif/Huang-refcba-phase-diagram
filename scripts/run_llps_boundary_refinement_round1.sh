...
MANIFEST="$ROOT/manifests/llps_boundary_refinement_round1.tsv"
RESULT_ROOT="$ROOT/results/llps_boundary_refinement_30ns_round1"
...
echo
echo "================================================================"
echo "LLPS_BOUNDARY_REFINEMENT_ROUND1: COMPLETE"
echo "================================================================"
