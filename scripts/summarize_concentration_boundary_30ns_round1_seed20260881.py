...
ROOT = Path("results/concentration_boundary_30ns_round1_seed20260881")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260881")):
    cluster_file = (
...
output = ROOT / "concentration_boundary_30ns_round1_seed20260881_metrics.csv"
