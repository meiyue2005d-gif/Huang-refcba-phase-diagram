...
MANIFEST="$ROOT/manifests/adaptive_c7p5_pH8p25_nacl100_seed20260850.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c7p5_pH8p25_nacl100_seed20260850"
...
echo
echo "================================================================"
echo "ADAPTIVE_C7P5_PH8P25_NACL100: COMPLETE"
echo "================================================================"
