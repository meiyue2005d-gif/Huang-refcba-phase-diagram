...
MANIFEST="$ROOT/manifests/adaptive_c3p75_pH8p25_nacl100_seed20260855.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c3p75_pH8p25_nacl100_seed20260855"
...
echo
echo "================================================================"
echo "ADAPTIVE_C3P75_PH8P25_NACL100: COMPLETE"
echo "================================================================"
