...
ROOT = Path("results/manual_boundary_30ns_round1_seed20260822")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260822")):
    cluster_file = (
...
output = ROOT / "manual_boundary_round1_seed20260822_metrics.csv"
