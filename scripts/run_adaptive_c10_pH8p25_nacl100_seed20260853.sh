...
MANIFEST="$ROOT/manifests/adaptive_c10_pH8p25_nacl100_seed20260853.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c10_pH8p25_nacl100_seed20260853"
...
echo
echo "================================================================"
echo "ADAPTIVE_C10_PH8P25_NACL100: COMPLETE"
echo "================================================================"
