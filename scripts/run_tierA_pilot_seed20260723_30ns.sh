...
QUEUE="$PROJECT/results/tierA_llps_30ns/tierA_pilot_seed20260723.tsv"
ROOT="$PROJECT/results/tierA_llps_30ns"
MASTER_LOG="$ROOT/master_pilot_seed20260723.log"
STATUS_FILE="$ROOT/status_pilot_seed20260723.tsv"
