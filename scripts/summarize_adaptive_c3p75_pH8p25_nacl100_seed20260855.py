...
ROOT = Path("results/adaptive_c3p75_pH8p25_nacl100_seed20260855")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260855")):
    cluster_file = (
...
output = ROOT / "adaptive_c3p75_pH8p25_nacl100_seed20260855_metrics.csv"
