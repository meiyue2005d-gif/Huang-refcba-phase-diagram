...
ROOT = Path("results/global_skeleton_30ns_seed20260876")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260876")):
    cluster_file = (
...
output = ROOT / "global_skeleton_30ns_seed20260876_metrics.csv"
