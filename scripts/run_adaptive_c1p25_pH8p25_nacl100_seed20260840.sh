...
MANIFEST="$ROOT/manifests/adaptive_c1p25_pH8p25_nacl100_seed20260840.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c1p25_pH8p25_nacl100_seed20260840"
...
echo
echo "================================================================"
echo "ADAPTIVE_C2P5_PH8P25_NACL100: COMPLETE"
echo "================================================================"
