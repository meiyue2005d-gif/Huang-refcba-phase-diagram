...
MANIFEST="$ROOT/manifests/manual_boundary_round2_seed20260823.tsv"
RESULT_ROOT="$ROOT/results/manual_boundary_30ns_round2_seed20260823"
...
echo
echo "================================================================"
echo "MANUAL_BOUNDARY_ROUND2: COMPLETE"
echo "================================================================"
