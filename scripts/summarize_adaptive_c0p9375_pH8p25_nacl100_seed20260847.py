...
ROOT = Path("results/adaptive_c0p9375_pH8p25_nacl100_seed20260847")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260847")):
    cluster_file = (
...
output = ROOT / "adaptive_c0p9375_pH8p25_nacl100_seed20260847_metrics.csv"
