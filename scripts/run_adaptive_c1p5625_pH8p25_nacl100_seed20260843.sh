...
MANIFEST="$ROOT/manifests/adaptive_c1p5625_pH8p25_nacl100_seed20260843.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c1p5625_pH8p25_nacl100_seed20260843"
...
echo
echo "================================================================"
echo "ADAPTIVE_C1P5625_PH8P25_NACL100: COMPLETE"
echo "================================================================"
