...
MANIFEST="$ROOT/manifests/adaptive_c0p625_pH8p25_nacl100_seed20260846.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c0p625_pH8p25_nacl100_seed20260846"
...
echo
echo "================================================================"
echo "ADAPTIVE_C0P625_PH8P25_NACL100: COMPLETE"
echo "================================================================"
