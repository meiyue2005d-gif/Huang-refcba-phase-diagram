...
ROOT = Path("results/highph_active_boundary_30ns_seed20260885")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260885")):
    cluster_file = (
...
output = ROOT / "highph_active_boundary_30ns_seed20260885_metrics.csv"
