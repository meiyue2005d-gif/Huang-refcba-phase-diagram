...
MANIFEST="$ROOT/manifests/adaptive_c1p640625_pH8p25_nacl100_seed20260848.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c1p640625_pH8p25_nacl100_seed20260848"
...
echo
echo "================================================================"
echo "ADAPTIVE_C1P640625_PH8P25_NACL100: COMPLETE"
echo "================================================================"
