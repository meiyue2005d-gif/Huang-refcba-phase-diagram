...
ROOT = Path("results/adaptive_c8p125_pH8p25_nacl100_seed20260851")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260851")):
    cluster_file = (
...
output = ROOT / "adaptive_c8p125_pH8p25_nacl100_seed20260851_metrics.csv"
