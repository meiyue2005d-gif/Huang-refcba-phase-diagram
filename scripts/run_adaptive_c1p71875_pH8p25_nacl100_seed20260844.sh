...
MANIFEST="$ROOT/manifests/adaptive_c1p71875_pH8p25_nacl100_seed20260844.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c1p71875_pH8p25_nacl100_seed20260844"
...
echo
echo "================================================================"
echo "ADAPTIVE_C1P71875_PH8P25_NACL100: COMPLETE"
echo "================================================================"
