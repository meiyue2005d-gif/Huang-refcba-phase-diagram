...
ROOT = Path("results/adaptive_c1p71875_pH8p25_nacl100_seed20260844")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260844")):
    cluster_file = (
...
output = ROOT / "adaptive_c1p71875_pH8p25_nacl100_seed20260844_metrics.csv"
