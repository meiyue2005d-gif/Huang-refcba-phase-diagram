...
ROOT = Path("results/adaptive_c1p5625_pH8p25_nacl100_seed20260843")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260843")):
    cluster_file = (
...
output = ROOT / "adaptive_c1p5625_pH8p25_nacl100_seed20260843_metrics.csv"
