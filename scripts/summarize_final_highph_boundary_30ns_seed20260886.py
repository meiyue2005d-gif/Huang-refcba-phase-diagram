...
ROOT = Path("results/final_highph_boundary_30ns_seed20260886")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260886")):
    cluster_file = (
...
output = ROOT / "final_highph_boundary_30ns_seed20260886_metrics.csv"
