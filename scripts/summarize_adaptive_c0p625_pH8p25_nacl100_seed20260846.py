...
ROOT = Path("results/adaptive_c0p625_pH8p25_nacl100_seed20260846")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260846")):
    cluster_file = (
...
output = ROOT / "adaptive_c0p625_pH8p25_nacl100_seed20260846_metrics.csv"
