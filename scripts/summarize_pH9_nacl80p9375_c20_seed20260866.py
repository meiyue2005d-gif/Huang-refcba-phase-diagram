...
ROOT = Path("results/pH9_nacl80p9375_c20_seed20260866")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260866")):
    cluster_file = (
...
output = ROOT / "pH9_nacl80p9375_c20_seed20260866_metrics.csv"
