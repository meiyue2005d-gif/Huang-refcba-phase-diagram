...
ROOT = Path("results/concentration_boundary_30ns_round2_seed20260882")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260882")):
    cluster_file = (
...
output = ROOT / "concentration_boundary_30ns_round2_seed20260882_metrics.csv"
