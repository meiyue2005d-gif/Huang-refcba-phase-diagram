...
ROOT = Path("results/concentration_boundary_30ns_round4_seed20260884")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260884")):
    cluster_file = (
...
output = ROOT / "concentration_boundary_30ns_round4_seed20260884_metrics.csv"
