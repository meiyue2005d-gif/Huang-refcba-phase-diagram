...
ROOT = Path("results/pH4_nacl250_c13p75_30ns_seed20260887")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260887")):
    cluster_file = (
...
output = ROOT / "pH4_nacl250_c13p75_30ns_seed20260887_metrics.csv"
