...
ROOT = Path("results/manual_boundary_30ns_round2_seed20260823")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260823")):
    cluster_file = (
...
output = ROOT / "manual_boundary_round2_seed20260823_metrics.csv"
