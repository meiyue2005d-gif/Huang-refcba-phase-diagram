...
ROOT = Path("results/concentration_skeleton_30ns_seed20260880")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260880")):
    cluster_file = (
...
output = ROOT / "concentration_skeleton_30ns_seed20260880_metrics.csv"
