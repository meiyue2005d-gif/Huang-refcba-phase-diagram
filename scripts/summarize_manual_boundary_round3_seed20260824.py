...
ROOT = Path("results/manual_boundary_30ns_round3_seed20260824")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260824")):
    cluster_file = (
...
output = ROOT / "manual_boundary_round3_seed20260824_metrics.csv"
