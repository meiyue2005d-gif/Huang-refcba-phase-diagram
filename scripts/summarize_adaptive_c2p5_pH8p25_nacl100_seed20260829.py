...
ROOT = Path("results/adaptive_c2p5_pH8p25_nacl100_seed20260829")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260829")):
    cluster_file = (
...
output = ROOT / "adaptive_c2p5_pH8p25_nacl100_seed20260829_metrics.csv"
