...
ROOT = Path("results/pH9_nacl79p53125_c20_seed20260868")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260868")):
    cluster_file = (
...
output = ROOT / "pH9_nacl79p53125_c20_seed20260868_metrics.csv"
