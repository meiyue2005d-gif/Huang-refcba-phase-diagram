...
MANIFEST="$ROOT/manifests/adaptive_c0p3125_pH8p25_nacl100_seed20260845.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c0p3125_pH8p25_nacl100_seed20260845"
...
echo
echo "================================================================"
echo "ADAPTIVE_C0P3125_PH8P25_NACL100: COMPLETE"
echo "================================================================"
