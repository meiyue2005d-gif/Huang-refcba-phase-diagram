...
ROOT = Path("results/adaptive_c0p3125_pH8p25_nacl100_seed20260845")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260845")):
    cluster_file = (
...
output = ROOT / "adaptive_c0p3125_pH8p25_nacl100_seed20260845_metrics.csv"
