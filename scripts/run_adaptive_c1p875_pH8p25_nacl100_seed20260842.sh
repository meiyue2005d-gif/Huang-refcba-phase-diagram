...
MANIFEST="$ROOT/manifests/adaptive_c1p875_pH8p25_nacl100_seed20260842.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c1p875_pH8p25_nacl100_seed20260842"
...
echo
echo "================================================================"
echo "ADAPTIVE_C1P875_PH8P25_NACL100: COMPLETE"
echo "================================================================"
