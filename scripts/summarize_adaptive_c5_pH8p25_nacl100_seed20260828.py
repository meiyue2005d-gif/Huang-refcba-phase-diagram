...
ROOT = Path("results/adaptive_c5_pH8p25_nacl100_seed20260828")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260828")):
    cluster_file = (
...
output = ROOT / "adaptive_c5_pH8p25_nacl100_seed20260828_metrics.csv"
