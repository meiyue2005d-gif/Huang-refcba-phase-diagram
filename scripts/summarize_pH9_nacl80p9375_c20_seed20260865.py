...
ROOT = Path("results/pH9_nacl80p9375_c20_seed20260865")
PARTICLES = 500
...
for run in sorted(ROOT.glob("pH*_seed20260865")):
    cluster_file = (
...
output = ROOT / "pH9_nacl80p9375_c20_seed20260865_metrics.csv"
