...
MANIFEST="$ROOT/manifests/adaptive_c1p25_pH8p25_nacl100_seed20260841.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c1p25_pH8p25_nacl100_seed20260841"
...
echo
echo "================================================================"
echo "ADAPTIVE_C1P25_PH8P25_NACL100: COMPLETE"
echo "================================================================"
