...
MANIFEST="$ROOT/manifests/adaptive_c6p25_pH8p25_nacl100_seed20260850.tsv"
RESULT_ROOT="$ROOT/results/adaptive_c6p25_pH8p25_nacl100_seed20260850"
...
echo
echo "================================================================"
echo "ADAPTIVE_C6P25_PH8P25_NACL100: COMPLETE"
echo "================================================================"
