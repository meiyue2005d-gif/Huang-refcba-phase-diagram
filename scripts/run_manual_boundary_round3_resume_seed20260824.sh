...
MANIFEST="$ROOT/manifests/manual_boundary_round3_resume_seed20260824.tsv"
RESULT_ROOT="$ROOT/results/manual_boundary_30ns_round3_seed20260824"
...
echo
echo "================================================================"
echo "MANUAL_BOUNDARY_ROUND3: COMPLETE"
echo "================================================================"
